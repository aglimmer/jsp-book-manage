...
//		String to = "3223782091@qq.com";
		String to = URLDecoder.decode(request.getParameter("email"),"utf-8");
		// 指定发送邮件的主机
	...
	//		message.setText("天长地久有时尽，此恨绵绵无绝期");
			message.setContent("<h4>尊敬的用户：<br><p>&nbsp;&nbsp;你好，这是一封来自系统服务器的消息，你此次操作的验证码是："+getCodes()+
			"，验证码有效时间90s,请勿告诉他人！<br>致学图书馆将为你提供优质的图书检索、借阅、查询等服务，欢迎访问！</p></h4>", "text/html;charset=utf-8");
	//		System.out.println("正在发送...");
			Transport.send(message);
			out.print("<p>邮件发送成功</p>");
